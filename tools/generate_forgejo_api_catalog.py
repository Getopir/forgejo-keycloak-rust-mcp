...
SEMANTIC_OVERLAY = {
    ...
    ("POST", "/repos/{owner}/{repo}/pulls/{index}/reviews"): "submit_pull_request_review",
    ("POST", "/repos/{owner}/{repo}/pulls/{index}/reviews/{id}"): "submit_pull_request_review",
    ("GET", "/repos/{owner}/{repo}/pulls/{index}.{diffType}"): "get_pull_request_diff",
