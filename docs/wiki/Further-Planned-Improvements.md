...
This is the short, current backlog after `2.1.0`, not a restatement of the
...
| Finish the OpenSSF project entry/badge after public-hosting prerequisites are met. | Complete in `1.3.0`; OpenSSF project `13642` earned the Passing badge and the service-generated badge is published in the README and wiki |
...
| Add a bounded `get_branch_status` read operation. | Complete in `2.1.0`; typed target, mapped ACL, response and item bounds, audit behavior, CLI, tests, and Forgejo 16 coverage reviewed |
