...
High-risk mutations such as repository deletion and admin actions require approval and remain disabled. The stable `1.0.2` release supports approval-backed pull-request merge, approval-backed release creation, generated API classification coverage, and crates.io-ready packaging while keeping non-reviewed generated endpoints disabled.
