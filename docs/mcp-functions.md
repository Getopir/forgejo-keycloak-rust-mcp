...
`0.3.15` exposes a Phase 0 MCP probe endpoint. It validates authentication and evaluates policy for registered operation names. It does not execute Forgejo mutations yet.
