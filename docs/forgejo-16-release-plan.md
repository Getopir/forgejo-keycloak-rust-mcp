...
| --- | --- | --- | --- |
| `2.0.0` | [#1](https://codeberg.org/GetOpir/forgejo-keycloak-rust-mcp/issues/1) | Establish and verify the Forgejo 16-only compatibility baseline | No new operation |
