...
| Security checks | Started | `docs/security-checks.md`, `deny.toml`, `.forgejo/workflows/ci.yml`; local fmt/check/test completed for `1.0.2`. |
...
| Release notes | Ready | `docs/release-notes/1.0.2.md`. |
