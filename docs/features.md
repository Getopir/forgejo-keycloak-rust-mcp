...
Generated coverage is metadata-only unless an endpoint has a reviewed semantic MCP operation. In `1.0.0`, 9 operations are exposed through the semantic overlay and 482 remain disabled.
