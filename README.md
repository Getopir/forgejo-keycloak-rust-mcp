...
`1.2.10` enforces JWT signing algorithms and minimum key strength at startup without expanding the gateway's executable Forgejo capability surface. The `1.2` feature series includes:
...
- [Release Notes 1.2.10](docs/release-notes/1.2.10.md)
